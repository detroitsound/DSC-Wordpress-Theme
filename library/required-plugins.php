<?php
    ...
    function my_theme_register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                'name'     => 'List Custom Taxonomy Widget', // The plugin name
                'slug'     => 'list-custom-taxonomy-widget', // The plugin slug (typically the folder name)
                'source'   => get_stylesheet_directory() . '/plugins/list-custom-taxonomy-widget.3.3.zip', // The plugin source
                'required' => true,
            ),
