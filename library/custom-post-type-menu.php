...
class Custom_Post_Type_Archive_Menu_Links {
  ...
  public static function inject_cpt_archives_menu_meta_box() {
    add_meta_box( 'add-cpt', __( 'Custom Post Type Archives', 'default' ), array(__CLASS__, 'wp_nav_menu_cpt_archives_meta_box'), 'nav-menus', 'side', 'default' );
  }
  ...
  public static function wp_nav_menu_cpt_archives_meta_box() {
    ...
    <p class="button-controls">
      <span class="add-to-menu">
        <!-- <img class="waiting hide" src="<?php echo esc_url( admin_url( 'images/wpspin_light.gif' ) ); ?>" alt="" /> -->
